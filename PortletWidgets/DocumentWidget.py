...
class CPSDocumentWidget(CPSWidget):
    """CPS Document widget
    """

    meta_type = "CPS Document Widget"
...
InitializeClass(CPSDocumentWidget)

class CPSDocumentWidgetType(CPSWidgetType):
    """CPS Document Widget Type
    """
    meta_type = "CPS Document Widget Type"
    cls = CPSDocumentWidget

InitializeClass(CPSDocumentWidgetType)

WidgetTypeRegistry.register(CPSDocumentWidgetType,
                            CPSDocumentWidget)
