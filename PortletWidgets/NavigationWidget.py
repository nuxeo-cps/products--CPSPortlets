...
class CPSNavigationWidget(CPSWidget):
    """CPS Navigation widget
    """

    meta_type = "CPS Navigation Widget"
...
InitializeClass(CPSNavigationWidget)

class CPSNavigationWidgetType(CPSWidgetType):
    """CPS Navigation Widget Type
    """
    meta_type = "CPS Navigation Widget Type"
    cls = CPSNavigationWidget

InitializeClass(CPSNavigationWidgetType)

WidgetTypeRegistry.register(CPSNavigationWidgetType,
                            CPSNavigationWidget)
