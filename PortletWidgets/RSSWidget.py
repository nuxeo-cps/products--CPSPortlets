...
class CPSRSSWidget(CPSWidget):
    """CPS RSS widget
    """

    meta_type = "CPS RSS Widget"
...
InitializeClass(CPSRSSWidget)

class CPSRSSWidgetType(CPSWidgetType):
    """CPS RSS Widget Type
    """
    meta_type = "CPS RSS Widget Type"
    cls = CPSRSSWidget

InitializeClass(CPSRSSWidgetType)

WidgetTypeRegistry.register(CPSRSSWidgetType,
                            CPSRSSWidget)
