...
class CPSLanguageWidget(CPSWidget):
    """CPS Language widget
    """

    meta_type = "CPS Language Widget"
...
InitializeClass(CPSLanguageWidget)

class CPSLanguageWidgetType(CPSWidgetType):
    """CPS Language Widget Type
    """
    meta_type = "CPS Language Widget Type"
    cls = CPSLanguageWidget

InitializeClass(CPSLanguageWidgetType)

WidgetTypeRegistry.register(CPSLanguageWidgetType,
                            CPSLanguageWidget)
