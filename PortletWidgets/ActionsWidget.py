...
class CPSActionsWidget(CPSWidget):
    """CPS Actions widget
    """

    meta_type = "CPS Actions Widget"
...
InitializeClass(CPSActionsWidget)

class CPSActionsWidgetType(CPSWidgetType):
    """CPS Actions Widget Type
    """
    meta_type = "CPS Actions Widget Type"
    cls = CPSActionsWidget

InitializeClass(CPSActionsWidgetType)

WidgetTypeRegistry.register(CPSActionsWidgetType,
                            CPSActionsWidget)
