text_portlet_type = {
    'title': 'portal_type_TextPortlet_title',
    'description': 'portal_type_TextPortlet_description',
    'content_icon': 'text_portlet_icon.png',
    ...
    'schemas': ('portlet_common', 'text_portlet', 'common', 'metadata'),
    'layouts': ('portlet_common', 'text_portlet'),
...
types = {'Text Portlet': text_portlet_type}
return types
