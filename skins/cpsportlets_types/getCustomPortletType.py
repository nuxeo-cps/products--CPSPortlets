custom_portlet_type = {
    'title': 'portal_type_CustomPortlet_title',
    'description': 'portal_type_CustomPortlet_description',
    'content_icon': 'custom_portlet_icon.png',
...
types = {'Custom Portlet': custom_portlet_type}
return types
