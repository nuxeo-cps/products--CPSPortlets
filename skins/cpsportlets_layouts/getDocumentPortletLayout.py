document_portlet_layout = {
    'widgets': {
        ...
        'cluster_no_fallback': {
            'type': 'CheckBox Widget',
            'data': {
                'fields': ('cluster_no_fallback',),
                'label_edit': 'cpsportlets_document_render_cluster_no_fallback_label',
                'is_i18n': True,
                'hidden_if_expr': 'not:context/cluster_id',
                'hidden_layout_modes': ('view',),
                'display_true': 'Yes',
                'display_false': 'No',
            },
        ...
        'context_rpath': {
            ...
            'data': {
                ...
                'is_required': False,
                'label': '',
                'label_edit': 'cpsportlets_document_context_rpath_label',
                'description': '',
                'help': '',
                'is_i18n': True,
                'readonly_layout_modes': (),
                ...
                'hidden_readonly_layout_modes': (),
                'hidden_empty': False,
                'hidden_if_expr': "context/render_container",
                'widget_mode_expr': '',
                'css_class': '',
                'css_class_expr': '',
                'javascript_expr': '',
    ...
    'layout': {
        ...
        'rows': [
            ...
            [{'widget_id': 'cluster_id', 'ncols': 1},
             {'widget_id': 'cluster_no_fallback', 'ncols': 2},
            ],
        ],
    },
}
