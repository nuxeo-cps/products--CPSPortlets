    ...
    'widgets': {
        ...
        'rel_depth': {
            ...
            'data': {
                ...
                'hidden_readonly_layout_modes': (),
                'hidden_empty': False,
                'hidden_if_expr': "python: context.display in ['folder_contents', 'subfolder_contents', 'navigation_tree', 'site_map', 'site_map_3_tabs', 'up_to_parent', 'folder_contents_dropdown_list']",
                'is_limited': False,
                'min_value': 0,
                'max_value': 0,
                'thousands_separator': '',
        ...
        'contextual': {
            ...
            'data': {
                ...
                'hidden_readonly_layout_modes': (),
                'hidden_empty': False,
                'hidden_if_expr': "python: context.display in ['vertical_breadcrumbs_menu', 'folder_contents', 'subfolder_contents', 'site_map', 'site_map_3_tabs', 'collapsible_menu', 'up_to_parent', 'folder_contents_dropdown_list']",
                'label_false': 'cpsschemas_label_false',
                'label_true': 'cpsschemas_label_true',
                'render_format': 'select',
            },
        ...
        'display_description': {
            ...
            'data': {
                ...
                'hidden_empty': False,
                'hidden_if_expr':
                    "python: context.display not in ['extended_site_map', 'site_map', 'site_map_3_tabs', 'folder_contents', 'subfolder_contents', 'navigation_tree', 'collapsible_menu']",
                'label_false': 'cpsschemas_label_false',
                'label_true': 'cpsschemas_label_true',
                'render_format': 'select',
            },
        ...
        'folder_prefixes': {
            ...
            'data': {
                ...
                'hidden_readonly_layout_modes': (),
                'hidden_empty': False,
                'hidden_if_expr': "python: context.display not in ['site_map', 'site_map_3_tabs']",
                'widget_mode_expr': '',
                'css_class': '',
                'css_class_expr': '',
                'javascript_expr': '',
